...
--
-- Struttura della tabella `furgoni_van_autoscout`
--

CREATE TABLE `furgoni_van_autoscout` (
  `id` int NOT NULL,
...
--
-- Indici per le tabelle `furgoni_van_autoscout`
--
ALTER TABLE `furgoni_van_autoscout`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT per la tabella `furgoni_van_autoscout`
--
ALTER TABLE `furgoni_van_autoscout`
